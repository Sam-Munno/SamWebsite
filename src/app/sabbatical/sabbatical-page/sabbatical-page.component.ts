...
export class SabbaticalPageComponent implements OnInit {
    ...
    { 
		...
		title: 'Northwest USA', 
		text: 'August 2024: Stanley (2008 Grand Marquis) and we hit the Rockies. Westbound, fully energized, and eager to see what summer had in store, Glacier, Yellowstone, and the Grand Tetons left us in awe.  Just remember to zip up the tent.', 
		time: '1.5 Months' 
	},
    { 
